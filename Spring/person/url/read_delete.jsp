...
<DIV class='title_line'>
  ...
  <A href="./list_by_urlgrpno.do?urlgrpno=${param.urlgrpno }" class='title_link'>${urlgrpVO.title }</A> > 
  ${urlVO.title } 수정 
</DIV>
...
<DIV class='content_body'>
  ...
  <DIV id='panel_delete' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    ...
    <FORM name='frm_delete' id='frm_delete' method='POST' action='./delete.do'>
      <input type='hidden' name='urlno' id='urlno' value="${urlVO.urlno }">
      
      <label>그룹 번호</label>: ${urlVO.urlgrpno }  
      <label>카테고리</label>: ${urlVO.title}  
