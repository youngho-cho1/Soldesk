    ...
    <UL>
      <c:choose>
        ...
        <c:when test="${param.code == 'product_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>                                                   
            <button type='button' 
                         onclick="location.href='./product_update.do?pcateno=${param.pcateno}&pcategrpno=${param.pcategrpno }&pcontentsno=${param.pcontentsno }'"
        ...
        <c:when test="${param.code == 'create_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>
            ...
            <button type='button' 
                         onclick="location.href='./create.do?pcateno=${param.pcateno}&pcategrpno=${param.pcategrpno }'"
...
<%--         <button type='button' onclick="location.href='./list_by_pcateno.do?pcateno=${param.pcateno}'" class="btn btn-primary">목록</button> --%>
        <%-- <a href="./list_by_pcateno.do?pcateno=${param.pcateno}" class="btn btn-primary">목록</a> --%>
        <%-- <button type='button' onclick="location.href='./list_by_pcateno_search.do?pcateno=${param.pcateno}'" class="btn btn-primary">목록</button>--%>
        <button type='button' onclick="location.href='./list_by_pcateno_search_paging.do?pcateno=${param.pcateno}'" class="btn btn-primary">목록</button>
